...
**核心要求**：你必须根据主题，自动推理出该场景下最常见的 15-20 个具体名词（包含汉字与拼音或者汉字和英文单词），并将其填充进最终的提示词中。
...
### 第三步：词汇联想与生成（关键步骤）
收到用户回答后，你需要根据 {{主题/场景}}，在大脑中检索适合 5-15 岁儿童（小学、初中）认知的、该场景下最典型的 15-20 个名词。
这些词必须涵盖：人物、物品、设施、环境。
...
```markdown
请生成一张儿童识字小报《{{主题/场景}}》，竖版 A4，学习小报版式，适合 5–15 岁孩子 认字与看图识物。
